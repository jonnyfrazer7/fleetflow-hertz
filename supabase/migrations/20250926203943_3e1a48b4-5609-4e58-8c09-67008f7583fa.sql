-- Insert 50 vehicles with realistic data (fixing column order)
...
-- Insert diverse workflows for these vehicles
...
-- Additional pending workflows for realistic load
...
-- Mix of completed workflows from earlier today
